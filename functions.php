...
function inzynieria_enqueue_scripts() {
    ...
    wp_enqueue_style( 'style-css', get_template_directory_uri() . '/style.css', array(), '1.0.279', 'all' );
    wp_enqueue_style( 'main-css', get_template_directory_uri() . '/css/main.css', array(), '1.0.280', 'all' );
    wp_enqueue_style( 'custom-css', get_template_directory_uri() . '/css/style.css', array(), '1.0.287', 'all' );
